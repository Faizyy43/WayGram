import {
  _setPrototypeOf,
  require_prop_types
} from "./chunk-FF5INUN2.js";
import {
  _extends
} from "./chunk-VJ522FFO.js";
import {
  _defineProperty,
  _typeof,
  toPropertyKey
...
var NimbleEmojiIndex = function() {
  ...
  _createClass(NimbleEmojiIndex2, [{
    ...
    value: function search4(value) {
      ...
      if (this.customEmojisList != custom2) this.addCustomToPool(custom2, this.originalPool);
...
var NimblePicker = function(_React$PureComponent) {
  ...
  _createClass(NimblePicker2, [{
    ...
    value: function handleEmojiSelect(emoji) {
      ...
      if (!this.hideRecent && !this.props.recent) frequently_default.add(emoji);
